        ...
        {type !== "list" && (
          <div className={styles.headerContentWrapper}>
            <div className={styles.headerContentWrapper1}>
              ...
              Embark on Unforgettable Journeys: Where Dreams Meet Destinations
              </h1>
              <p className={styles.headerDesc}>
              Discover Your Perfect Getaway with Our Exclusive Hotels, Packages, and Travel Experiences
              </p>
